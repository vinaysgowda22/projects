...
from backend.gmail.gmail_service import GmailService, get_gmail_service, reset_gmail_service
...
class TestGmailService:
    ...
    def test_get_credentials_from_keychain_success(self, mock_credentials, mock_get_password):
