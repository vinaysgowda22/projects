...
class Transaction(Base, TimestampMixin):
    ...
    gmail_id: Mapped[Optional[str]] = mapped_column(String(100), nullable=True, unique=True, index=True)
    
    # Transaction type and status
    transaction_type: Mapped[str] = mapped_column(
        String(20), nullable=False
    )  # "debit", "credit", "transfer"
    status: Mapped[str] = mapped_column(String(20), nullable=False, default="posted")  # "pending", "posted"
